...
class Rently_Commission_System {
    ...
    public function add_settings_page() {
        add_submenu_page(
            ...
            __('Commission Settings', 'rently-booking'),
            __('Commission', 'rently-booking'),
            'manage_options',
            'rently-commission',
    ...
    public function register_settings() {
        register_setting('rently_commission_settings', 'rently_commission_rate', array(
            'type' => 'number',
            'default' => 10,
    ...
    public function render_settings_page() {
        ...
        <div class="wrap">
            ...
            <form method="post" action="options.php">
                <?php
                settings_fields('rently_commission_settings');
                do_settings_sections('rently_commission_settings');
                ?>
                <table class="form-table">
                    <tr>
                        <th scope="row">
                            <label for="rently_commission_rate"><?php _e('Commission Rate (%)', 'rently-booking'); ?></label>
                        </th>
                        <td>
                            <input type="number" 
                                   id="rently_commission_rate" 
                                   name="rently_commission_rate" 
                                   value="<?php echo esc_attr($this->commission_rate); ?>" 
                                   min="0" 
                                   max="100" 
                                   step="0.01" 
                                   class="regular-text" />
